...
from utils.color_analysis import calculate_average_color_optimized, color_to_hex
...
class SourceImagePalette:
    ...
    def find_closest_match(self, target_color: Tuple[int, int, int]) -> SourceImage:
        ...
        """
        #TO DO: Implement efficient color matching using numpy for vectorized distance calculation
    ...
    def find_closest_matches(self, target_color: Tuple[int, int, int], n: int = 5) -> List[Tuple[SourceImage, float]]:
        ...
        """
        #TO DO: Implement efficient color matching to return top N matches with distances
